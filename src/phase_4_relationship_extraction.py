...
employment_patterns = [
    [
        ...
        {"LEFT_ID": "verb", "REL_OP": ">", "RIGHT_ID": "subject", "RIGHT_ATTRS": {"DEP": "nsubj", "ENT_TYPE": "PERSON"}},
        {"LEFT_ID": "verb", "REL_OP": ">", "RIGHT_ID": "object", "RIGHT_ATTRS": {"DEP": "dobj", "ENT_TYPE": "ORG"}}
    ],
    [
        {"RIGHT_ID": "verb", "RIGHT_ATTRS": {"LEMMA": "hire", "POS": "VERB"}},
        {"LEFT_ID": "verb", "REL_OP": ">", "RIGHT_ID": "passive_subj", "RIGHT_ATTRS": {"DEP": "nsubj:pass", "ENT_TYPE": "PERSON"}},
        {"LEFT_ID": "verb", "REL_OP": ">", "RIGHT_ID": "agent", "RIGHT_ATTRS": {"DEP": "agent", "ENT_TYPE": "ORG"}}
    ],
    [
        {"RIGHT_ID": "cop", "RIGHT_ATTRS": {"LEMMA": "be", "POS": "AUX"}},
        {"LEFT_ID": "cop", "REL_OP": ">", "RIGHT_ID": "subject", "RIGHT_ATTRS": {"DEP": "nsubj", "ENT_TYPE": "PERSON"}},
        {"LEFT_ID": "cop", "REL_OP": ">", "RIGHT_ID": "position", "RIGHT_ATTRS": {"DEP": "attr", "ENT_TYPE": "DESIGNATION"}}
    ],
    [
        {"RIGHT_ID": "led", "RIGHT_ATTRS": {"LEMMA": "lead", "POS": "VERB"}},
        {"LEFT_ID": "led", "REL_OP": ">", "RIGHT_ID": "person", "RIGHT_ATTRS": {"DEP": "nsubj", "ENT_TYPE": "PERSON"}},
        {"LEFT_ID": "led", "REL_OP": ">", "RIGHT_ID": "team", "RIGHT_ATTRS": {"DEP": "dobj"}}
    ],
    [
        {"RIGHT_ID": "managed", "RIGHT_ATTRS": {"LEMMA": "manage", "POS": "VERB"}},
        {"LEFT_ID": "managed", "REL_OP": ">", "RIGHT_ID": "person", "RIGHT_ATTRS": {"DEP": "nsubj", "ENT_TYPE": "PERSON"}},
        {"LEFT_ID": "managed", "REL_OP": ">", "RIGHT_ID": "target", "RIGHT_ATTRS": {"DEP": "dobj"}}
    ],
    [
        {"RIGHT_ID": "served", "RIGHT_ATTRS": {"LEMMA": "serve", "POS": "VERB"}},
        {"LEFT_ID": "served", "REL_OP": ">", "RIGHT_ID": "person", "RIGHT_ATTRS": {"DEP": "nsubj", "ENT_TYPE": "PERSON"}},
...
for match_id, token_ids in matches:
    span = [doc_dep[i] for i in token_ids]
    print(" → ".join([t.text for t in span]))
